...
function generateTokyoFAQs(jobTypeName: string, avgSalary: number, jobTypeId: string): FAQItem[] {
  const jobSpecific: Record<string, FAQItem[]> = {
    ...
    landscaping: [
      { question: '東京で造園施工管理の求人が増えている理由は何ですか？', answer: '東京都が推進する「2030年東京グリーンビズ」計画により屋上緑化・壁面緑化の促進施策が強化され、大型再開発では緑地整備が義務化されています。麻布台ヒルズ・虎ノ門ヒルズ・神宮外苑再開発など大型民間案件でも造園工事の需要が拡大しており、他都市と比べて求人数・単価ともに高い水準が続いています。' },
      { question: '東京の造園施工管理で年収500万円以上を目指せますか？', answer: '可能です。1級造園施工管理技士を保有し、都市緑化・屋上緑化または大型公共造園工事の施工管理実績がある場合、東京では年収500万円台の求人を十分狙えます。植栽基盤設計の経験や樹木医資格があれば、さらに希少価値が高まります。施工管理特化型エージェントへの登録で非公開求人を確認しましょう。' },
    ],
  };
